 ...
 *
 * @author lishaoping
 * @ClassName CommonMergeChainReadable
 * @date 2021.04.08 16:18
 */
@Slf4j
public class CommonMergeChainReadable<T> implements IReadable<T> {
    ...
    public CommonMergeChainReadable(Chain<T> chain1, Chain<T> chain2){
        this.chain1 = chain1;
        this.chain2 = chain2;
    }
